...
class Memorize(object):
    ...
    def set_parent_file(self):
        """
        Sets self.parent_file to the absolute path of
        the file containing the memorized function.
        :return:
        """
    ...
    def is_safe_cache(self):
        ...
        functions has not been update since the cache was
        last saved
        :return:
        """
    ...
    def read_cache(self):
        """
        Read a pickled dictionary into self.timestamp
        and self.cache. See self.save_cache
        :return:
        """
    ...
    def save_cache(self):
        """
        Pickle the file's timestamp and the
        function's cache in a dictionary object
        :return:
        """
    ...
    def cache_exists(self):
        """
        Returns True if a matching cache
